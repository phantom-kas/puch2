/// todo move to its own utils file
...
chrome.action.onClicked.addListener(function (a) {
  chrome.tabs.create({ url: chrome.runtime.getURL("bot.html") }, function (b) {
    console.log(b);
  });
  chrome.tabs.query(
    { url: "https://www.instagram.com/*", currentWindow: !0 },
...
function openDashboardAndInstagram() {
  chrome.tabs.create({
    url: chrome.runtime.getURL("bot.html"),
  });
...
function OnMessageReceive(a) {
  ...
  if ("AddUsers" == a.Tag) AddUsersToDatabase(a.Users);
    ...
    a.error.includes("ResizeObserver") ||
      ...
      //   success: function (e) {},
      // });
      postData("https://instoo.com/user/ClientError", {
    ...
    //   (blocked = !0);
    postData("https://instoo.com/user/blocked", {
